...
if(!isset($_SESSION["loggedin-user"]) || $_SESSION["loggedin-user"] !== true){
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="user-update.php?id=<?php echo htmlspecialchars($_SESSION['id']); ?>">Update Info</a>
          </li>
          <li class="nav-item">
